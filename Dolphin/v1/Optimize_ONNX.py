...
MODEL_PLANS = {
    ...
    "Dolphin_ProbePrefillGreedy":           Plan(method=DEFAULT_METHOD, process=False, optimize=True, transformer=True),
    "Dolphin_ProbePrefillPenaltyGreedy":    Plan(method=DEFAULT_METHOD, process=False, optimize=True, transformer=True),
    "Dolphin_ProbePrefillSampling":         Plan(method=DEFAULT_METHOD, process=False, optimize=True, transformer=True),
