...
model_path = os.path.join(original_folder_path, "Paraformer_Streaming_Encoder.onnx")                        # The original fp32 model name.
optimized_model_path = os.path.join(optimized_folder_path, "Paraformer_Streaming_Encoder.onnx")             # The optimized model name.
# model_path = os.path.join(original_folder_path, "Paraformer_Streaming_Decoder.onnx")                      # The original fp32 model name.
# optimized_model_path = os.path.join(optimized_folder_path, "Paraformer_Streaming_Decoder.onnx")           # The optimized model name.
...
if use_gpu_fp16:
    model.convert_float_to_float16(
        ...
        op_block_list=['DynamicQuantizeLinear', 'DequantizeLinear', 'DynamicQuantizeMatMul', 'Range', 'MatMulIntegerToFloat', 'Softmax']
    )
