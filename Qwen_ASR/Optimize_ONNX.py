...
model_names = [
    "Qwen3_ASR_Encoder",
    "Qwen3_ASR_Decoder_Embed",
    "Qwen3_ASR_Decoder_Main",
...
block_size = 16                          # [16, 32, 64, 128, 256]; A smaller block_size yields greater accuracy but increases quantization time and model size.
...
fp16_block_list = ['DynamicQuantizeLinear', 'DequantizeLinear', 'DynamicQuantizeMatMul', 'MatMulIntegerToFloat']
# Common fp16 overflow operators: 'Sqrt', 'Pow', 'ReduceSum', 'ReduceMean', 'Softmax', 'Sigmoid', 'Erf'
...
for model_name in model_names:
    ...
    if use_openvino or "encoder" in model_path.lower():
        opt_level = 1
    elif use_int4 and "concat" in model_path.lower():
        opt_level = 0
    else:
        opt_level = 2
